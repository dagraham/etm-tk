...
\texttt{-d} & depth (integer). CLI only. The default, \verb'-d 0', includes all \\
            & outline levels. Use \verb'-d 1' to include only level 1, \verb'-d 2' to \\
            & include levels 1 and 2 and so forth. \\
